            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 17.89*fem),
                  width: double.infinity,
                  height: 466.11*fem,
                  child: Stack(
                    children: [
                ...
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(39.11*fem, 0*fem, 38.11*fem, 89*fem),
                  width: double.infinity,
                  height: 149*fem,
                  child: Stack(
                    children: [
                          ...
                          child: Row(
                            ...
                            children: [
                                  ...
                                  children: [
                                    InkWell(
                                      child: Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(12*fem, 0*fem, 0.57*fem, 46.21*fem),
                                        width: double.infinity,
                                        child: Row(
                                          crossAxisAlignment: CrossAxisAlignment.end,
                                          children: [
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6*fem, 8.09*fem),
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    InkWell(
                                      child: Container(
                                        // waterglassa9Z (1:204)
                                        margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1*fem, 53*fem),
                                        width: 26*fem,
                                        height: 29*fem,
                                        child: Image.asset(
                              ...
                              Container(
                                ...
                                margin: EdgeInsets.fromLTRB(0*fem, 7*fem, 0*fem, 12.09*fem),
                                width: 52*fem,
